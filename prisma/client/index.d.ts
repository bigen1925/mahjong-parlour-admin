  ...
  */
    ...
    > = S extends true
        ...
        ? 'include' extends U
            ? Organization &
                  {
                      [P in TrueKeys<S['include']>]: P extends 'Parlour'
            ...
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof Organization
                      ? Organization[P]
                      : P extends 'Parlour'
    ...
    export interface OrganizationDelegate {
        ...
        findUnique<T extends OrganizationFindUniqueArgs>(
            ...
            T,
            Prisma__OrganizationClient<Organization | null>,
            Prisma__OrganizationClient<OrganizationGetPayload<T> | null>
        >;
        ...
        create<T extends OrganizationCreateArgs>(
            ...
            T,
            Prisma__OrganizationClient<Organization>,
        ...
        ): Promise<GetOrganizationAggregateType<T>>;
    }
    ...
    export class Prisma__OrganizationClient<T> implements Promise<T> {
        ...
        Parlour<T extends ParlourFindManyArgs = {}>(
            args?: Subset<T, ParlourFindManyArgs>
        ): CheckSelect<T, Promise<Array<Parlour>>, Promise<Array<ParlourGetPayload<T>>>>;

        Staff<T extends StaffFindManyArgs = {}>(
            args?: Subset<T, StaffFindManyArgs>
        ): CheckSelect<T, Promise<Array<Staff>>, Promise<Array<StaffGetPayload<T>>>>;

        Guest<T extends GuestFindManyArgs = {}>(
            args?: Subset<T, GuestFindManyArgs>
    ...
    export type ParlourGetPayload<S extends boolean | null | undefined | ParlourArgs, U = keyof S> = S extends true
        ? Parlour
        : S extends undefined
        ? never
        ...
        ? 'include' extends U
            ? Parlour &
                  {
                      [P in TrueKeys<S['include']>]: P extends 'organization'
            ...
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof Parlour
                      ? Parlour[P]
    ...
    export interface ParlourDelegate {
         ...
         * })
         **/
        aggregate<T extends ParlourAggregateArgs>(
            args: Subset<T, ParlourAggregateArgs>
        ): Promise<GetParlourAggregateType<T>>;
    }
    ...
    export class Prisma__ParlourClient<T> implements Promise<T> {
        ...
        organization<T extends OrganizationArgs = {}>(
            args?: Subset<T, OrganizationArgs>
        ): CheckSelect<
            T,
            Prisma__OrganizationClient<Organization | null>,
            Prisma__OrganizationClient<OrganizationGetPayload<T> | null>
        ...
        staffs<T extends StaffFindManyArgs = {}>(
            args?: Subset<T, StaffFindManyArgs>
        ): CheckSelect<T, Promise<Array<Staff>>, Promise<Array<StaffGetPayload<T>>>>;

        guests<T extends GuestFindManyArgs = {}>(
            args?: Subset<T, GuestFindManyArgs>
        ): CheckSelect<T, Promise<Array<Guest>>, Promise<Array<GuestGetPayload<T>>>>;

        Table<T extends TableFindManyArgs = {}>(
            args?: Subset<T, TableFindManyArgs>
    ...
    export type StaffGetPayload<S extends boolean | null | undefined | StaffArgs, U = keyof S> = S extends true
        ? Staff
        : S extends undefined
        ? never
        ...
        ? 'include' extends U
            ...
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof Staff
                      ? Staff[P]
                      : P extends 'organization'
                      ? OrganizationGetPayload<S['select'][P]>
                      : P extends 'parlours'
    ...
    export interface StaffDelegate {
         ...
         *
         **/
        deleteMany<T extends StaffDeleteManyArgs>(args?: SelectSubset<T, StaffDeleteManyArgs>): Promise<BatchPayload>;
         ...
         *
         **/
        updateMany<T extends StaffUpdateManyArgs>(args: SelectSubset<T, StaffUpdateManyArgs>): Promise<BatchPayload>;
    ...
    export class Prisma__StaffClient<T> implements Promise<T> {
        ...
        parlours<T extends ParlourFindManyArgs = {}>(
            args?: Subset<T, ParlourFindManyArgs>
        ): CheckSelect<T, Promise<Array<Parlour>>, Promise<Array<ParlourGetPayload<T>>>>;

        Player<T extends PlayerFindManyArgs = {}>(
            args?: Subset<T, PlayerFindManyArgs>
    ...
    export type GuestGetPayload<S extends boolean | null | undefined | GuestArgs, U = keyof S> = S extends true
        ? Guest
        : S extends undefined
        ? never
        ...
        ? 'include' extends U
            ...
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof Guest
                      ? Guest[P]
                      : P extends 'organization'
                      ? OrganizationGetPayload<S['select'][P]>
                      : P extends 'parlours'
    ...
    export interface GuestDelegate {
         ...
         *
         **/
        deleteMany<T extends GuestDeleteManyArgs>(args?: SelectSubset<T, GuestDeleteManyArgs>): Promise<BatchPayload>;
         ...
         *
         **/
        updateMany<T extends GuestUpdateManyArgs>(args: SelectSubset<T, GuestUpdateManyArgs>): Promise<BatchPayload>;
    ...
    export type TableGetPayload<S extends boolean | null | undefined | TableArgs, U = keyof S> = S extends true
        ? Table
        : S extends undefined
        ? never
        ...
        ? 'include' extends U
            ? Table &
                  {
                      [P in TrueKeys<S['include']>]: P extends 'parlour' ? ParlourGetPayload<S['include'][P]> : never;
                  }
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof Table
                      ? Table[P]
                      : P extends 'parlour'
    ...
    export interface TableDelegate {
         ...
         *
         **/
        deleteMany<T extends TableDeleteManyArgs>(args?: SelectSubset<T, TableDeleteManyArgs>): Promise<BatchPayload>;
         ...
         *
         **/
        updateMany<T extends TableUpdateManyArgs>(args: SelectSubset<T, TableUpdateManyArgs>): Promise<BatchPayload>;
    ...
    export class Prisma__TableClient<T> implements Promise<T> {
        ...
        parlour<T extends ParlourArgs = {}>(
            args?: Subset<T, ParlourArgs>
        ): CheckSelect<T, Prisma__ParlourClient<Parlour | null>, Prisma__ParlourClient<ParlourGetPayload<T> | null>>;
    ...
    export type GameGetPayload<S extends boolean | null | undefined | GameArgs, U = keyof S> = S extends true
        ? Game
        : S extends undefined
        ? never
        ...
        ? 'include' extends U
            ? Game &
                  {
                      [P in TrueKeys<S['include']>]: P extends 'players'
                          ? Array<PlayerGetPayload<S['include'][P]>>
                          : never;
                  }
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof Game
                      ? Game[P]
                      : P extends 'players'
                      ? Array<PlayerGetPayload<S['select'][P]>>
                      : never;
    ...
    export interface GameDelegate {
         ...
         *
         **/
        deleteMany<T extends GameDeleteManyArgs>(args?: SelectSubset<T, GameDeleteManyArgs>): Promise<BatchPayload>;
         ...
         *
         **/
        updateMany<T extends GameUpdateManyArgs>(args: SelectSubset<T, GameUpdateManyArgs>): Promise<BatchPayload>;
    ...
    export class Prisma__GameClient<T> implements Promise<T> {
        ...
        players<T extends PlayerFindManyArgs = {}>(
            args?: Subset<T, PlayerFindManyArgs>
        ): CheckSelect<T, Promise<Array<Player>>, Promise<Array<PlayerGetPayload<T>>>>;
    ...
    export type PlayerGetPayload<S extends boolean | null | undefined | PlayerArgs, U = keyof S> = S extends true
        ? Player
        : S extends undefined
        ? never
        ...
        ? 'include' extends U
            ? Player &
                  {
                      [P in TrueKeys<S['include']>]: P extends 'game'
                          ...
                          ? Array<GameResultGetPayload<S['include'][P]>>
                          : never;
                  }
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof Player
                      ? Player[P]
                      : P extends 'game'
                      ...
                      : P extends 'GameResult'
                      ? Array<GameResultGetPayload<S['select'][P]>>
                      : never;
              }
            : Player
        : Player;
    ...
    export interface PlayerDelegate {
         ...
         *
         **/
        deleteMany<T extends PlayerDeleteManyArgs>(args?: SelectSubset<T, PlayerDeleteManyArgs>): Promise<BatchPayload>;
         ...
         *
         **/
        updateMany<T extends PlayerUpdateManyArgs>(args: SelectSubset<T, PlayerUpdateManyArgs>): Promise<BatchPayload>;
        ...
        ): Promise<GetPlayerAggregateType<T>>;
    }
    ...
    export class Prisma__PlayerClient<T> implements Promise<T> {
        ...
        guest<T extends GuestArgs = {}>(
            args?: Subset<T, GuestArgs>
        ): CheckSelect<T, Prisma__GuestClient<Guest | null>, Prisma__GuestClient<GuestGetPayload<T> | null>>;

        staff<T extends StaffArgs = {}>(
            args?: Subset<T, StaffArgs>
        ): CheckSelect<T, Prisma__StaffClient<Staff | null>, Prisma__StaffClient<StaffGetPayload<T> | null>>;

        GameResult<T extends GameResultFindManyArgs = {}>(
            args?: Subset<T, GameResultFindManyArgs>
    ...
    > = S extends true
        ...
        ? 'include' extends U
            ? GameResult &
                  {
                      [P in TrueKeys<S['include']>]: P extends 'player' ? PlayerGetPayload<S['include'][P]> : never;
                  }
            : 'select' extends U
            ? {
                  [P in TrueKeys<S['select']>]: P extends keyof GameResult
                      ? GameResult[P]
                      : P extends 'player'
    ...
    export interface GameResultDelegate {
        ...
        findUnique<T extends GameResultFindUniqueArgs>(
            ...
            T,
            Prisma__GameResultClient<GameResult | null>,
            Prisma__GameResultClient<GameResultGetPayload<T> | null>
        >;
         ...
         * })
         **/
        aggregate<T extends GameResultAggregateArgs>(
            args: Subset<T, GameResultAggregateArgs>
        ): Promise<GetGameResultAggregateType<T>>;
    }
    ...
    export type ParlourCreateManyWithoutOrganizationInput = {
        create?: XOR<
            Enumerable<ParlourUncheckedCreateWithoutOrganizationInput>,
            Enumerable<ParlourCreateWithoutOrganizationInput>
        >;
    ...
    export type StaffCreateManyWithoutOrganizationInput = {
        create?: XOR<
            Enumerable<StaffUncheckedCreateWithoutOrganizationInput>,
            Enumerable<StaffCreateWithoutOrganizationInput>
        >;
    ...
    export type GuestCreateManyWithoutOrganizationInput = {
        create?: XOR<
            Enumerable<GuestUncheckedCreateWithoutOrganizationInput>,
            Enumerable<GuestCreateWithoutOrganizationInput>
        >;
    ...
    export type GameResultCreateManyWithoutPlayerInput = {
        create?: XOR<
            Enumerable<GameResultUncheckedCreateWithoutPlayerInput>,
            Enumerable<GameResultCreateWithoutPlayerInput>
        >;
